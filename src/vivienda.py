...
#Esto sigue siendo cada 100 habitantes
...
for col in columnas_comunes:
    df_totales[col] = ((df_extranjeros[col] / 100) * df_poblacion[col]).round().astype('Int64')
...
print('Se han generado las gráficas en sus correspondientes carpetas para cada hipótesis en la ruta ../img')
